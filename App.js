...
function App() {
  ...
  const TinhTrongLuongQuyDoi = (chieuDai, chieuRong, chieuCao) => {
    ...
    const preCheckNumber = (number) => number && !isNaN(parseFloat(number)) && parseFloat(number) >= 0
    if (preCheckNumber(chieuDai) && preCheckNumber(chieuRong) && preCheckNumber(chieuCao)) {
      // Trọng lượng quy đổi = Dài * Rộng * Cao / 5000
      setTrongLuongQuyDoi((parseFloat(chieuDai) * parseFloat(chieuRong) * parseFloat(chieuCao) / 5000).toFixed(2).toString())
  ...
  const formatCurrency = (amount) => {
    ...
    if (amount == '' || isNaN(parseFloat(amount)))
      ...
      const formattedAmount = new Intl.NumberFormat({ minimumFractionDigits: 0 }).format(amount);
  ...
  const validationSchema = Yup.object().shape({
    sdtNguoiGui: Yup.number()
      ...
      .test('', 'Số điện thoại phải có ít nhất 9 chữ số', value => value && value.toString().length >= 9),
    hoTenNguoiGui: Yup.string()
      .required("Hãy nhập họ tên người gửi!")
      .matches(/^[\p{L} ]+$/u, 'Hãy nhập tên hợp lệ!'),
    diaChiNguoiGui: Yup.string()
      .required("Hãy nhập địa chỉ người gửi!"),
    diemDiNguoiGui: Yup.string()
      .required("Hãy nhập điểm đi!"),
    ...
    hoTenNguoiNhan: Yup.string()
      ...
      .matches(/^[\p{L} ]+$/u, 'Hãy nhập tên hợp lệ!'),
    diaChiNguoiNhan: Yup.string()
      .required("Hãy nhập địa chỉ người nhận!"),
    buuCucDen: Yup.string()
      .required("Hãy nhập bưu cục đến!"),
    noiDungHangHoa: Yup.string()
      .required("Hãy nhập nội dung hàng hóa!"),
    giaTriSanPham: Yup.number()
      .required("Hãy nhập giá trị sản phẩm!")
      .test('', 'Hãy nhập giá trị sản phẩm!', value => value !== 0),
    phuongThucVanChuyen: Yup.string()
      .required('Hãy chọn phương thức vận chuyển!'),
    trongLuong: Yup.number()
      .required('Hãy nhập trọng lượng!'),
    soKien: Yup.number()
      .required('Hãy nhập số kiện!')
  })

  const initialValues = { // Danh sách các giá trị khởi tạo
    sdtNguoiGui: "",
    hoTenNguoiGui: "",
    diaChiNguoiGui: "",
    diemDiNguoiGui: "",
  ...
  const services = [
    { label: 'EXPRESS', value: 0, service: 'Dịch vụ tiêu chuẩn', money: formatCurrency(500) },
    { label: 'FAST', value: 1, service: 'Dịch vụ chuyển nhanh', money: formatCurrency(5000) },
    { label: 'SUPER', value: 2, service: 'Dịch vụ hỏa tốc', money: formatCurrency(1000) },]
            ...
            <View>
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  <View style={styles.text_container}>{/*Khung text*/}
                    <AntDesign name="user" size={24} color="black" style={styles.icon} />
                    <Text>Người gửi</Text>
                  </View>

                  <View style={{ borderBottomColor: '#e0e0e0', borderBottomWidth: 1, marginTop: 10 }} />{/*Đường kẻ ngang*/}
                  ...
                  <View style={[
                    ...
                    <Feather name="phone" size={24} color="gray" style={styles.icon} />
                    <TextInput
                  ...
                  {errors.hoTenNguoiGui && touched.hoTenNguoiGui
                    ? <Text style={styles.text_error}>{errors.hoTenNguoiGui}</Text>
                    : null}
                  ...
                  <View style={[
                    ...
                    <Feather name="map" size={24} color="gray" style={styles.icon} />
                    <View style={{ flex: 1 }}>
                      <TextInput
                        placeholder='Địa chỉ'
                        style={styles.input}
                      ...
                      <View style={styles.counter}>{/*Đếm chiều dài ký tự nhập vào 0/250 của địa chỉ người gửi*/}
                        <Text style={[styles.important_text, { fontSize: 10 }]}>{values.diaChiNguoiGui.length}/250</Text>
                      </View>
                    </View>
                  </View>
                  {errors.diaChiNguoiGui && touched.diaChiNguoiGui
                    ? <Text style={styles.text_error}>{errors.diaChiNguoiGui}</Text>
                    : null}
                  ...
                  <View style={[
                    ...
                    <Feather name="map-pin" size={24} color="gray" style={styles.icon} />
                    <TextInput
                      placeholder='Điểm đi'
                      style={styles.input}
                      autoCapitalize='words'
                  ...
                  {errors.diemDiNguoiGui && touched.diemDiNguoiGui
                    ? <Text style={styles.text_error}>{errors.diemDiNguoiGui}</Text>
                    : null}
                </View>
              </View>
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  <View style={styles.text_container}>{/*Khung text khách hàng VIP*/}
                    <Image source={require('./assets/vip.png')} style={[styles.icon, { width: 24, height: 24 }]}></Image>
                    <Text>Khách hàng VIP</Text><Text style={styles.important_text}> *</Text>
                  </View>
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  <View style={styles.text_container}>{/*Khung text phương thức thanh toán*/}
                    <MaterialCommunityIcons name="hand-coin-outline" size={24} color="black" style={styles.icon} />
                    <Text>Phương thức thanh toán</Text><Text style={styles.important_text}> *</Text>
                  </View>
                  <View style={styles.input_container}>
                    <TextInput
                      autoCapitalize='none'
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  <View style={styles.text_container}>{/*Khung text phương thức vận chuyển*/}
                    <MaterialCommunityIcons name="truck-outline" size={24} color="black" style={styles.icon} />
                    <Text>Phương thức vận chuyển</Text><Text style={styles.important_text}> *</Text>
                  </View>
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  ...
                  {errors.hoTenNguoiNhan && touched.hoTenNguoiNhan
                    ? <Text style={styles.text_error}>{errors.hoTenNguoiNhan}</Text>
                    : null}
                  ...
                  <View style={[
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={styles.counter}>{/*Đếm chiều dài ký tự nhập vào 0/250 của địa chỉ người nhận*/}
                        <Text style={[styles.important_text, { fontSize: 10 }]}>{values.diaChiNguoiNhan.length}/250</Text>
                      </View>
                    </View>
                  </View>
                  {errors.diaChiNguoiNhan && touched.diaChiNguoiNhan
                    ? <Text style={styles.text_error}>{errors.diaChiNguoiNhan}</Text>
                    : null}
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  <View style={styles.text_container}>{/*Khung text*/}
                    <MaterialCommunityIcons name="package-variant-closed" size={24} color="black" style={styles.icon} />
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <View style={[
                      ...
                      <MaterialCommunityIcons name="package-variant-closed" size={24} color="gray" style={styles.icon} />
                      <View style={{ flex: 1 }}>
                        <TextInput
                        ...
                        <View style={styles.counter}>{/*Đếm chiều dài ký tự nhập vào 0/250 của nội dung hàng hóa*/}
                          <Text style={[styles.important_text, { fontSize: 10 }]}>{values.noiDungHangHoa.length}/250</Text>
                        </View>
                      </View>
                    </View>
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    >{/*Khung input text area giá trị sản phẩm*/}
                      <Ionicons name="cash-outline" size={24} color="gray" style={styles.icon} />
                      <TouchableWithoutFeedback
                        onPress={() => {
                          setModalVisible(true)
                          setModalMessage('Hãy tích chọn Phí bảo hiểm\ntrước khi nhập Giá trị sản phẩm')
                        }}>
                        <View style={{ flex: 1 }}>
                          <TextInput
                            name='giaTriSanPham'
                            ...
                            keyboardType='numeric'
                            maxLength={50}
                            onChangeText={(value) => setFieldValue('giaTriSanPham', unformatCurrency(value))}
                  ...
                  {errors.giaTriSanPham && touched.giaTriSanPham
                    ? <Text style={styles.text_error}>{errors.giaTriSanPham}</Text>
                    : null}

                  <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={[styles.input_container, styles.important_input, { width: '48%' }]}>{/*Khung input HÀNG HÓA*/}
                      {/* <MaterialCommunityIcons name="truck-outline" size={24} color="black" style={styles.icon} /> */}
                      {/* <TextInput
                    ...
                    <View style={[styles.input_container, styles.important_input, { width: '48%' }]}>{/*Khung input EXPRESS*/}
                      {/* <MaterialCommunityIcons name="truck-outline" size={24} color="black" style={styles.icon} />
                      <TextInput
                        placeholder='EXPRESS'
                        autoCapitalize='none'
                      ...
                      <View style={styles.wrapIconText} >
                        <Modal
                          ...
                          <TouchableWithoutFeedback onPress={() => setisExpress(false)} >
                            <View style={styles.centeredView}>
                              <View style={styles.modalView}>
                                <View style={styles.titleModal}>
                                  <Text style={[styles.modalText, { justifyContent: 'center', width: '100%' }]}>Dịch vụ</Text>
                                </View>
                                <View>
                                  <RadioForm
                                  >
                                        ...
                                        key={i}
                                          ...
                                          <RadioButton key={i}  >
                                            <RadioButtonInput
                                              ...
                                              buttonOuterColor={valueOfExpress === i ? '#2196f3' : '#000'}
                                              buttonSize={20}
                                              buttonOuterSize={30}
                                              buttonStyle={{}}
                                              buttonWrapStyle={{ paddingLeft: 10, paddingTop: 5 }}
                                            />
                                            ...
                                            >
                                              <RadioButtonLabel
                                                ...
                                                labelStyle={{ fontSize: 20, color: 'black', width: 180, paddingVertical: 10, paddingLeft: 0 }}
                                                labelWrapStyle={{}}
                                              />
                        ...
                        <Pressable
                          ...
                          <View style={{ flexDirection: 'row' }}>
                            <MaterialCommunityIcons name="truck-outline" size={24} color="black" style={styles.icon} />
                            <Text style={{ paddingTop: 2 }}>{services[valueOfExpress].label}</Text>
                          </View>
                        </Pressable>
                      </View>
                      {/* // */}
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View
                      ...
                      <MaterialCommunityIcons name="weight" size={24} color="black" style={styles.icon} />
                      <TextInput
                        name='trongLuong'
                        ...
                        keyboardType='numeric'
                        maxLength={10}
                        onChangeText={value => setFieldValue('trongLuong', value.replace(/[^0-9.]/g, ''))}
                    ...
                    <View
                      ...
                      <MaterialCommunityIcons name="inbox-multiple" size={24} color="black" style={styles.icon} />
                      <TextInput
                        keyboardType='numeric'
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ width: '48%' }}>
                      {errors.trongLuong && touched.trongLuong
                        ? <Text style={styles.text_error}>{errors.trongLuong}</Text>
                        : null}
                    </View>
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={[styles.input_container, { width: '32%' }]}>{/*Khung input chiều dài*/}
                      <TextInput
                        placeholder='Dài (Cm)'
                        keyboardType='numeric'
                        style={styles.input}
                    ...
                    <View style={[styles.input_container, { width: '32%' }]}>{/*Khung input chiều cao*/}
                      <TextInput
                        placeholder='Cao (Cm)'
                        keyboardType='numeric'
                        style={styles.input}
                  ...
                  <View style={[styles.input_container, styles.disabled_input]}>{/*Khung input trọng lượng quy đổi(KG)*/}
                    <TextInput
                      editable={false}
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={[styles.switch_container, { flex: 0, justifyContent: 'flex-start', marginRight: 5 }]}>{/*Khung Switch VUN*/}
                      <Text>VUN</Text>
                      <Switch
                        onValueChange={(value) => {
              ...
              <View style={styles.big_container}>
                <View style={styles.small_container}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>{/*Khung input COD*/}
                    <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1 }}>{/*Khung input phí COD*/}
                      <View style={[styles.input_container, { borderWidth: 0 }]}>
                  ...
                  <View style={[styles.input_container, { borderWidth: 0, marginTop: 0 }]}>{/*Khung input tiền phải thu*/}
                  ...
                  <View style={[styles.input_container, { borderWidth: 0, marginTop: 0 }]}>{/*Khung input phí bảo hiểm*/}
                  ...
                  <View style={[styles.input_container, { borderWidth: 0, marginTop: 0 }]}>{/*Khung input số tiền giảm giá*/}
                  ...
                  <View style={[styles.input_container, { borderWidth: 0, marginTop: 0 }]}>{/*Khung input các phí khác*/}
                    ...
                    <TextInput
                      ...
                      style={[
                        ...
                        styles.input,
                        { marginTop: 0 }]}
                      onChangeText={(value) => setFieldValue('cacPhiKhac', unformatCurrency(value))}
                      value={formatCurrency(values.cacPhiKhac)}
                    />
                  </View>

                  <View style={styles.input_container}>{/*Khung input ghi chú*/}
                    <MaterialCommunityIcons name="note-edit-outline" size={24} color="black" style={styles.icon} />
                    <TextInput
                      placeholder='Ghi chú'
                      autoCapitalize='none'
                      style={styles.input}
                  ...
                  <View style={[styles.text_container, { marginTop: 10, justifyContent: 'space-between' }]}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
                      <Text style={{ fontSize: 20, fontWeight: 'bold' }}>9,000,000</Text>
                      <Text style={{ color: 'orange', marginLeft: 5, fontSize: 20 }}>₫</Text>
                    </View>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.big_container}>
                <TouchableOpacity
                  ...
                  onPress={handleImageCapture}>{/*Nút Submit*/}
                  <AntDesign name="camerao" size={24} color="white" style={styles.icon} />
                  <Text style={{
                    color: 'white',
                    fontWeight: 'bold',
                    fontSize: 15
                ...
                <TouchableOpacity
                  ...
                  onPress={handleSubmit}>{/*Nút Submit*/}
                  <Text style={{
                    color: 'white',
                    fontWeight: 'bold',
                    fontSize: 15
